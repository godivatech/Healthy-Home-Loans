export const ScrollToTop = () => {
    return (
        <div className="fixed text-white text-[22px] bg-neutral-900 shadow-[rgba(0,0,0,0.1)_0px_3px_10px_0px] box-border caret-transparent hidden h-[45px] leading-[33px] text-center w-[45px] z-[999] rounded-[50%] right-5 bottom-5 hover:bg-primary hover:shadow-[rgba(50,50,93,0.11)_0px_4px_6px_0px,rgba(0,0,0,0.08)_0px_1px_3px_0px]">
