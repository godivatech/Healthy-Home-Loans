...
export const PageBanner = ({ title, breadcrumb = "Home", headingLevel = "h2" }: PageBannerProps) => {
    return (
        <div
                ...
                <div className="table-cell align-middle">
                    <div className="max-w-[1140px] w-full mx-auto px-3">
                        <div className="text-center -mt-2.5">
                            {headingLevel === "h1" ? (
                                <h1 className="text-neutral-900 text-3xl md:text-5xl font-semibold">{title}</h1>
                            ) : (
