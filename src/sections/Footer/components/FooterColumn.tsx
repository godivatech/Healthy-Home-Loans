                    ...
                    <div className="flex items-center gap-4 text-white">
                        ...
                        <div className="flex items-center gap-5">
                            {props.socialLinks?.twitter && (
                                <a href={props.socialLinks.twitter} className="hover:text-primary transition-colors">
                            ...
                            {props.socialLinks?.instagram && (
                                <a href={props.socialLinks.instagram} className="hover:text-primary transition-colors">
                            ...
                            {props.socialLinks?.facebook && (
                                <a href={props.socialLinks.facebook} className="hover:text-primary transition-colors">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {props.socialLinks?.linkedin && (
                                <a href={props.socialLinks.linkedin} className="hover:text-primary transition-colors">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="relative box-border caret-transparent mb-5 pl-10">
                            ...
                            {props.emails.map((email, index) => (
                                ...
                                >
                                    <a
                                        href={email.url}
                                        className="box-border caret-transparent block hover:text-primary hover:border-primary"
                                    >
                                        {email.text}
                                    </a>
                                </span>
