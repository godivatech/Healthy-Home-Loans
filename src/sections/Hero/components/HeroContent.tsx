    ...
    return (
        <div className="box-border caret-transparent max-w-full md:max-w-[800px]">
            ...
            <div className="box-border caret-transparent flex gap-4">
                <Link
                    to="/contact"
                    className="relative text-white text-base bg-primary box-border caret-transparent inline-block leading-[22.5px] text-center z-[1] overflow-hidden px-[30px] py-3.5 rounded-[5px] font-medium md:text-lg md:leading-6 md:px-[45px] hover:bg-neutral-900 transition-colors"
                >
                    Get Loan
                </Link>
                <Link
                    to="/services"
                    className="relative text-primary text-base bg-white border border-primary box-border caret-transparent inline-block leading-[22.5px] text-center z-[1] overflow-hidden px-[30px] py-3.5 rounded-[5px] font-medium md:text-lg md:leading-6 md:px-[45px] hover:bg-gray-50 transition-colors"
                >
                    Our Services
                </Link>
            </div>
