...
export const FundingSection = () => {
    return (
        <div className="box-border py-[50px] md:py-[100px]">
            <div className="box-border max-w-none w-full mx-auto px-3 md:max-w-[1140px]">
                <div className="box-border text-center mb-[30px] md:mb-[45px]">
                    <span className="text-primary box-border font-medium uppercase tracking-wider">
                        Our Process
                    </span>
                ...
                <div className="items-center box-border flex flex-wrap -mx-3">
                    <FundingSteps />
                    <LoanCalculator />
                </div>
            </div>
